...
If a backend `appProtocol` isn't specified an implementation MAY infer the backend protocol through its own means. 
...
ServicePort Protocol | Service Port AppProtocol | Supported
-|-|- 
`kubernetes.io/h2c` | `TCP`  | Yes
`kubernetes.io/h2c` | `UDP`  | No
`kubernetes.io/h2c` | `SCTP` | No
`kubernetes.io/ws`  | `TCP`  | Yes
`kubernetes.io/ws`  | `UDP`  | No
`kubernetes.io/ws`  | `SCTP` | No
`kubernetes.io/wss` | `TCP`  | Yes
`kubernetes.io/wss` | `UDP`  | No
`kubernetes.io/wss` | `SCTP` | No

ServicePort `appProtocol` | ServicePort Protocol | Route Type | Supported
-|-|-|-
`kubernetes.io/raw` | `TCP`  | `HTTPRoute` | No
`kubernetes.io/raw` | `UDP`  | `HTTPRoute` | No
`kubernetes.io/raw` | `TCP`  | `GRPCRoute` | No
`kubernetes.io/raw` | `UDP`  | `UDPRoute`  | Yes
`kubernetes.io/raw` | `TCP`  | `TCPRoute`  | Yes
`kubernetes.io/raw` | `TCP`  | `TLSRoute`  | Conditional [1]
`kubernetes.io/h2c` | `TCP`  | `HTTPRoute` | Yes
`kubernetes.io/h2c` | `UDP`  | `HTTPRoute` | No
`kubernetes.io/h2c` | `TCP`  | `GRPCRoute` | Yes [2]
`kubernetes.io/h2c` | `UDP`  | `GRPCRoute` | No
`kubernetes.io/h2c` | `UDP`  | `UDPRoute`  | No
`kubernetes.io/h2c` | `TCP`  | `TCPRoute`  | TBD [4]
`kubernetes.io/h2c` | `TCP`  | `TLSRoute`  | Conditional [1]
`kubernetes.io/ws`  | `TCP`  | `HTTPRoute` | Yes
`kubernetes.io/ws`  | `UDP`  | `HTTPRoute` | TBD [3]
`kubernetes.io/ws`  | `TCP`  | `GRPCRoute` | No
`kubernetes.io/ws`  | `UDP`  | `GRPCRoute` | No
`kubernetes.io/ws`  | `TCP`  | `TCPRoute`  | TBD [4]
`kubernetes.io/ws`  | `TCP`  | `TLSRoute`  | Conditional [1]
`kubernetes.io/wss` | `TCP`  | `HTTPRoute` | Conditional [1]
`kubernetes.io/wss` | `UDP`  | `HTTPRoute` | TBD [3]
`kubernetes.io/wss` | `TCP`  | `GRPCRoute` | No
`kubernetes.io/wss` | `UDP`  | `GRPCRoute` | No
`kubernetes.io/wss` | `TCP`  | `TCPRoute`  | TBD [4]
`kubernetes.io/wss` | `TCP`  | `TLSRoute`  | TBD [4]

1. Only if there is a corresponding `TLSConnectionPolicy` - see [GEP-1897](TODO)
2. GRPC works over h2c
3. [Websocket over HTTP3 - RFC9220](https://www.rfc-editor.org/rfc/rfc9220.html). Open question should we
